...
btnScrollTo.addEventListener('click', function (e) {
  ...
  // A better way to smoothly scroll
  /*   window.scrollTo({
    left: s1coords.left + scrollX,
    top: s1coords.top + scrollY,
    behavior: 'smooth',
  }); */
  // The modern way to scroll smoothly
...
//   alert('you are inside h1 heading!');
...
// // Event listener can be removed anywhere
...
// 1st slide 0%, 2nd slide 100%, 3rd slide 200%
let curSlide = 0;

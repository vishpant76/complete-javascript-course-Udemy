...
// const userName = [];
// for (const word of userArr) {
//   userName.push(word[0]);
// }
// const userNameString = userName.join('');
// console.log(userNameString);

// const userName = userArr.map(function(word){
//   return word[0]
// })

// const userName = userArr.map(word => word[0]);
// const userNameString = userArr.map(word => word[0]).join('');
// console.log(userNameString);
